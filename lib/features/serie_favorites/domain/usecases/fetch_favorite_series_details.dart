...
class FetchFavoriteSeriesDetails implements UseCase<List<Series>, NoParams> {
  final SerieFavoritesRepository repository;

  FetchFavoriteSeriesDetails(this.repository);

  @override
  Future<Either<Failure, List<Series>>> call(NoParams params) async {
    try {
      final favorites = await repository.fetchFavoriteSeriesDetails();
      return favorites;
    } catch (e) {
